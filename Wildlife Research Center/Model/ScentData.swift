...
struct ScentData : Codable {
    ...
    var scent_elimination_end_cap : Int!
    
    init(scent_Elimination_Facings: Int, scent_Elimination_Pallet_Displays : Int, scent_And_Dispenser_Facings: Int, scent_And_Dispenser_Pallet_Displays : Int, does_this_Brand_have_An_Exclusive_EndCap : Int, scent_elimination_end_cap : Int  ) {
        ...
        self.scent_elimination_end_cap = scent_elimination_end_cap
